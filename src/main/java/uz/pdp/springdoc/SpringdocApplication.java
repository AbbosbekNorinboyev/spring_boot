...
import uz.pdp.springdoc.comment.Comment;
import uz.pdp.springdoc.comment.CommentRepository;
import uz.pdp.springdoc.post.Post;
import uz.pdp.springdoc.post.PostRepository;
import uz.pdp.springdoc.todo.Todo;
import uz.pdp.springdoc.todo.TodoRepository;
...
public class SpringdocApplication {
    ...
    public OpenAPI springOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("PDP Online Java(SpringDOC)")
                        .description("This Document Designed For SpringDOC Project")
                        .version("10")
                        .contact(new Contact()
                                .name("Elmurodov Javohir")
                                .email("john.lgd65@gmail.com")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:2210").description("Production Server"),
